...
//
// Includes all the tests for System.Collection.Concurrent.Experimental.ConcurrentDictionary in 
...
namespace NonBlockingTests
{
    public class DictionaryImplTests
    {
        ...
        {
            Experimental.ConcurrentDictionary<int, int> cd = new Experimental.ConcurrentDictionary<int, int>();
        ...
        {
            // using Experimental.ConcurrentDictionary<TKey, TValue> class
            Experimental.ConcurrentDictionary<string, string> dict1 = new Experimental.ConcurrentDictionary<string, string>();
            dict1["key"] = null;
        }
        ...
        public static void TestAddNullValue_IDictionaryOfString_null()
        {
            ...
            IDictionary<string, string> dict2 = new Experimental.ConcurrentDictionary<string, string>();
            dict2["key"] = null;
            dict2.Add("key2", null);
        }
        ...
        public static void TestAddNullValue_IDictionary_ReferenceType_null()
        {
            ...
            IDictionary dict3 = new Experimental.ConcurrentDictionary<string, string>();
            dict3["key"] = null;
            dict3.Add("key2", null);
        }
        ...
        public static void TestAddNullValue_IDictionary_ValueType_null_indexer()
        {
            ...
            Action action = () =>
            {
                IDictionary dict4 = new Experimental.ConcurrentDictionary<string, int>();
                dict4["key"] = null;
            };
        ...
        public static void TestAddNullValue_IDictionary_ValueType_null_add()
        {
            Action action = () =>
            {
                IDictionary dict5 = new Experimental.ConcurrentDictionary<string, int>();
                dict5.Add("key", null);
            };
            Assert.Throws<ArgumentException>(action);
        }
        ...
        public static void TestAddValueOfDifferentType()
        {
            Action action = () =>
            {
                IDictionary dict = new Experimental.ConcurrentDictionary<string, string>();
                dict["key"] = 1;
            };
            Assert.Throws<ArgumentException>(action);
        ...
        {
            Experimental.ConcurrentDictionary<int, int> dictConcurrent = new Experimental.ConcurrentDictionary<int, int>(cLevel, 1);
        ...
        {
            IDictionary<int, int> dict = new Experimental.ConcurrentDictionary<int, int>(cLevel, 1);
        ...
        {
            Experimental.ConcurrentDictionary<int, int> dict = new Experimental.ConcurrentDictionary<int, int>(cLevel, 1);
        ...
        {
            Experimental.ConcurrentDictionary<int, int> dict = new Experimental.ConcurrentDictionary<int, int>();
        ...
        {
            Assert.Throws<ArgumentNullException>(() => new Experimental.ConcurrentDictionary<string, int>().TryRemove(new KeyValuePair<string, int>(null, 42)));
            new Experimental.ConcurrentDictionary<int, int>().TryRemove(new KeyValuePair<int, int>(0, 0)); // no error when using default value type
            new Experimental.ConcurrentDictionary<int?, int>().TryRemove(new KeyValuePair<int?, int>(0, 0)); // or nullable
        }

        [Fact]
        public static void TryRemove_KeyValuePair_RemovesSuccessfullyAsAppropriate()
        {
            var dict = new Experimental.ConcurrentDictionary<string, int>();
        ...
        {
            var dict = new Experimental.ConcurrentDictionary<string, string>(StringComparer.OrdinalIgnoreCase);
        ...
        {
            var cd = new Experimental.ConcurrentDictionary<string, int>(new OrdinalStringComparer());
            cd["test"] = 10;
        ...
        {
            var dictionary = new Experimental.ConcurrentDictionary<int, int>(new[] { new KeyValuePair<int, int>(1, 1) });
        ...
        //{
        //    DebuggerAttributes.ValidateDebuggerDisplayReferences(new Experimental.ConcurrentDictionary<string, int>());
        //    Experimental.ConcurrentDictionary<string, int> dict = new Experimental.ConcurrentDictionary<string, int>();
        //    dict.TryAdd("One", 1);
        //    dict.TryAdd("Two", 2);
        ...
        //{
        //    Type proxyType = DebuggerAttributes.GetProxyType(new Experimental.ConcurrentDictionary<string, int>());
        ...
        {
            AssertDefaultComparerBehavior(new Experimental.ConcurrentDictionary<EqualityApiSpy, int>((IEqualityComparer<EqualityApiSpy>)null));

            AssertDefaultComparerBehavior(new Experimental.ConcurrentDictionary<EqualityApiSpy, int>(new[] { new KeyValuePair<EqualityApiSpy, int>(new EqualityApiSpy(), 1) }, null));

            AssertDefaultComparerBehavior(new Experimental.ConcurrentDictionary<EqualityApiSpy, int>(1, new[] { new KeyValuePair<EqualityApiSpy, int>(new EqualityApiSpy(), 1) }, null));

            AssertDefaultComparerBehavior(new Experimental.ConcurrentDictionary<EqualityApiSpy, int>(1, 1, null));

            void AssertDefaultComparerBehavior(Experimental.ConcurrentDictionary<EqualityApiSpy, int> dictionary)
            {
        ...
        public static void TestComparerGetter()
        {
            ...
            {
                var dc = new Experimental.ConcurrentDictionary<T, object>(comparer);
        ...
        public static void TestConstructor_Negative()
        {
            Assert.Throws<ArgumentNullException>(
               () => new Experimental.ConcurrentDictionary<int, int>((ICollection<KeyValuePair<int, int>>)null));
            // "TestConstructor:  FAILED.  Constructor didn't throw ANE when null collection is passed");

            Assert.Throws<ArgumentNullException>(
               () => new Experimental.ConcurrentDictionary<int, int>((ICollection<KeyValuePair<int, int>>)null, EqualityComparer<int>.Default));
            // "TestConstructor:  FAILED.  Constructor didn't throw ANE when null collection and non null IEqualityComparer passed");

            Assert.Throws<ArgumentNullException>(
               () => new Experimental.ConcurrentDictionary<string, int>(new[] { new KeyValuePair<string, int>(null, 1) }));
            // "TestConstructor:  FAILED.  Constructor didn't throw ANE when collection has null key passed");

            // Duplicate keys.
            Assert.Throws<ArgumentException>(() => new Experimental.ConcurrentDictionary<int, int>(new[] { new KeyValuePair<int, int>(1, 1), new KeyValuePair<int, int>(1, 2) }));

            Assert.Throws<ArgumentNullException>(
               () => new Experimental.ConcurrentDictionary<int, int>(1, null, EqualityComparer<int>.Default));
            // "TestConstructor:  FAILED.  Constructor didn't throw ANE when null collection is passed");

            Assert.Throws<ArgumentOutOfRangeException>(
               () => new Experimental.ConcurrentDictionary<int, int>(0, 10));
            // "TestConstructor:  FAILED.  Constructor didn't throw AORE when <1 concurrencyLevel passed");

            Assert.Throws<ArgumentOutOfRangeException>(
               () => new Experimental.ConcurrentDictionary<int, int>(-1, 0));
        ...
        {
            var dictionary = new Experimental.ConcurrentDictionary<string, int>();
            Assert.Throws<ArgumentNullException>(
        ...
        {
            IDictionary dictionary = new Experimental.ConcurrentDictionary<string, int>();
        ...
        {
            IDictionary<string, int> dictionary = new Experimental.ConcurrentDictionary<string, int>();
        ...
        {
            ICollection dictionary = new Experimental.ConcurrentDictionary<int, int>();
            Assert.False(dictionary.IsSynchronized, "TestICollection:  FAILED.  IsSynchronized returned true!");

            int key = -1;
            int value = +1;
            //add one item to the dictionary
            ((Experimental.ConcurrentDictionary<int, int>)dictionary).TryAdd(key, value);
        ...
        public static void TestICollection_Negative()
        {
            ...
            //add one item to the dictionary
            ((Experimental.ConcurrentDictionary<int, int>)dictionary).TryAdd(1, 1);
        ...
        {
            var dictionary = new Experimental.ConcurrentDictionary<int, int>();
            for (int i = 0; i < 10; i++)
        ...
        public static void TestTryUpdate()
        {
            ...
            var dict = new Experimental.ConcurrentDictionary<int, Struct16>();
        ...
        {
            var cd = new Experimental.ConcurrentDictionary<int, KeyValuePair<long, long>>();
